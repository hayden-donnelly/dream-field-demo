...
public class TonemappingLut : PostEffectsBase {
    ...
    // adaptive parameters
	public float adaptiveGreyOffset = 0.0f;
	...
	void OnRenderImage (RenderTexture source, RenderTexture destination) {
        ...
        // the standard function in log space tends to get much too bright, so the -2.0 is added so that
        // the zero value tends to have little adjustment and makes the slider more intuitive
        float middleGrey = 0.18f * Mathf.Pow(2.0f,(adaptiveGreyOffset-2));
